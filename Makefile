...
all: check_submodules bin/lps-node-firmware.elf bin/lps-node-firmware.dfu bin/lps-node-firmware.hex
...
clean:
	rm -f bin/lps-node-firmware.elf bin/lps-node-firmware.dfu bin/lps-node-firmware.hex bin/lps-node-firmware.bin bin/.map $(OBJS)
